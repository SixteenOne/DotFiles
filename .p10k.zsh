# Generated by Powerlevel10k configuration wizard on 2022-03-09 at 16:48 GMT.
...
() {
  ...
  ##################################[ dir: current directory ]##################################
  # Current directory background color. (default 4)
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=4
  # Default current directory foreground color (default 254).
